...
-- Create Vaccine Companies, again addresses are random
INSERT INTO Company (name, street, city, province, postalCode) VALUES 
    ("Company A", "2774 Tycos Dr", "Toronto", "ON", "M5T1T4"),
    ("Company B", "3457 Merton Street", "Toronto", "ON", "M1L3K7"),
    ("Company C", "3948 Robson St", "Vancouver", "BC", "V6B3K9");

-- Create lots of vaccine
INSERT INTO Lot (number, doses, company, productionDate, expiryDate, site) VALUES 
    ("CA0097", 35, "Company A", "2021-06-09", "2021-12-23", "Site 1"),
    ("CB0045", 50, "Company B", "2021-06-22", "2022-02-18", "Site 2"),
    ("CC0056", 81, "Company C", "2021-07-09", "2022-02-23", "Site 3"),
    ("CA0415", 25, "Company A", "2021-07-12", "2022-03-04", "Site 1"),
    ("CB0079", 93, "Company B", "2021-08-02", "2022-03-10", "Site 2"),
    ("CC0253", 45, "Company C", "2021-08-23", "2022-04-06", "Site 3"),
    ("CA0684", 35, "Company A", "2021-09-03", "2022-04-21", "Site 1"),
    ("CB0531", 78, "Company B", "2021-09-22", "2022-08-16", "Site 2"),
    ("CC0656", 35, "Company C", "2021-09-27", "2022-08-19", "Site 3"),
    ("CA1347", 34, "Company A", "2021-10-18", "2022-09-28", "Site 1"),
    ("CB0981", 46, "Company B", "2021-11-03", "2022-10-14", "Site 2"),
    ("CC1324", 86, "Company C", "2021-11-26", "2022-11-16", "Site 3"),
    ("CA1985", 37, "Company A", "2021-12-08", "2022-12-20", NULL), -- Most recent doeses undelivered
    ("CB1258", 68, "Company B", "2021-12-20", "2022-12-21", NULL),
    ("CC1722", 86, "Company C", "2021-12-22", "2022-12-30", NULL);
